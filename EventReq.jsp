...
<html lang="en">
    ...
    <head>
        <title>Event Requirements</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container">
            <form action="bk1">
                ...
                <label for="from">Select Type of Food</label>
                <select name="t17">
                    <option>select..</option>
                    <option value="Vege">Vege</option>
                    <option value="NonVege">NonVege</option>
                    
                </select><br><br>

                <label for="from">Decoration Type</label>
                <select name="t18">
                    <option>select..</option>
                    <option value="Flower">Flower type</option>
                    <option value="lights">Lights</option>
                    <option value="general">Regular type</option>
                    <option value="Luxurious">Extra Feactures</option>
                </select><br><br>
